    ...
    >
      ...
      <div className="md:flex md:flex-row md:gap-9">
        <div className="flex flex-col ">
          <div className="mb-7 sm:mb-12">
            <motion.div
              ...
              initial="hidden"
              whileInView="visible"
              className="text-base  sm:text-xl font-medium text-gray-500 max-w-[54ch] mb-3 sm:mb-5"
            >
        ...
        <motion.div
          ...
          initial="hidden"
          whileInView="visible"
          className="group max-w-[180px] sm:max-w-xs mx-auto relative md:self-start"
        >
